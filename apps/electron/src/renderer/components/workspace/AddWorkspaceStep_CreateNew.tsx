...
export function AddWorkspaceStep_CreateNew({
  ...
  const { t } = useTranslation('components/workspace/AddWorkspaceStep_CreateNew')
  ...
  useEffect(() => {
    ...
    const validateSlug = async () => {
      ...
      try {
        ...
        if (result.exists) {
          setError(t('A workspace named "{slug}" already exists', { slug }))
        } else {
          setError(null)
        }
      } catch (err) {
  ...
  return (
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description={t('Enter a name and choose where to store your workspace.')}
      />
      ...
      <div className="mt-6 w-full space-y-6">
        ...
        <div className="space-y-3">
          ...
          <AddWorkspace_RadioOption
            ...
            subtitle={t('under .craft-agent folder')}
          />
          ...
          <AddWorkspace_RadioOption
            ...
            subtitle={customPath || t('Pick a place to put your new workspace.')}
