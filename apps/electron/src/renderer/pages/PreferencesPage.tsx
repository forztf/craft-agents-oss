...
export default function PreferencesPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      <PanelHeader title={t('Preferences')} actions={headerActions} />
      <Separator />
      <ScrollArea className="flex-1">
        <div className="p-4 space-y-6">
          {/* Basic Info */}
          <section>
            <SectionHeader>{t('Basic Info')}</SectionHeader>
          ...
          <section>
            ...
            <Textarea
              ...
              placeholder={t("Any additional information you'd like to share with the AI assistant...")}
